  ...
  return (
    <div style={{ overflow: 'hidden' }}>
      <svg
        ...
        style={{ fill: '#3e3d3d', width: '113%', height: 182, transform: 'scaleX(-1)' }}
      >
      ...
      <div className='container '>
        <div className='row '>
          ...
          <div className='col-md-4 m-2 my-md-auto mx-md-auto order-0 order-md-1'>
            <h2 className='text-center title-login'>Encuentra las mejores recetas!!</h2>
            <form onSubmit={hanldeSubmit}>
              ...
              <input
                ...
                onChange={handleOnChange}
              />
              <button type='submit' className='btn btn-primary form-control my-2 btn-sm p-2'>
                Iniciar Sesión
              </button>
            </form>
          </div>
